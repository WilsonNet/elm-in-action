...
var $author$project$PhotoGroove$initialModel = {
	choosenSize: $author$project$PhotoGroove$Large,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Photos Grooves')
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Surpresinha!')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGroove$sizeToString(model.choosenSize))
					]),
				A2(
					$elm$core$List$map,
